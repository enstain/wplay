...
## Если ваш репозиторий в GitHub, используйте такую конфигурацию
 set :repository,    "git@github.com:enstain/wplay.git"
...
namespace :deploy do
  task :update_config do
    ...
    #run "rvm use #{rvm_ruby_string} do bundle exec rake db:mongoid:create_indexes RAILS_ENV=production"
  end
end
...
before 'deploy:assets:precompile', 'deploy:update_config'